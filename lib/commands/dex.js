  ...
  usage: '[pokémon name or id]',
    ...
    try {
      ...
      const embed = new RichEmbed()
        ...
        .setImage(`https://raw.githubusercontent.com/thattomperson/rowan/master/assets/types/${pokemon.types.map(a => a.type.name).join('-')}.png`)
      ...
      msg.client.rollbar.error(e)
      return msg.reply(`Something went very wrong`)
    }
	},
};