  ...
  usage: '[pokémon name or id]',
    ...
    try {
      ...
      const embed = new RichEmbed()
        ...
        // .addField('Type', new Attachment(`https://raw.githubusercontent.com/thattomperson/rowan/master/assets/types/normal.png`))

        .setFooter(`![normal](https://raw.githubusercontent.com/thattomperson/rowan/master/assets/types/normal.png)`)
        // .setImage(pokemon.types.map(a => )[0])
      // Send the embed to the same channel as the message
      msg.channel.send(embed);
      msg.channel.send(`![normal](https://raw.githubusercontent.com/thattomperson/rowan/master/assets/types/normal.png)`)
